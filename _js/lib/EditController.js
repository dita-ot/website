...
define([
  ...
  return function EditController() {
    ...
    function createEditLink() {
      ...
      if (location.pathname.indexOf('/dev/') != -1 && $('.generated').length === 0) {
        ...
        if ($link.length === 0) {
          $link = $('<a class="btn btn-success btn-xs pull-right" id="editLink" target="_blank" title="Edit this file"><span class="glyphicon glyphicon-pencil"></span> Edit this page</a>')
